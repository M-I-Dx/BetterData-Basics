...
async def train(hyperparameters: Hyperparameters):
    ...
    root = "/home/mid/BetterData/data/"  # Figure out the root director of docker after mounting the volume
    model_path = "/home/mid/BetterData/model/" + "model.pt" # Figure out the model path after mounting the volume
